      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >訓練，可以有效率的屠殺<nuxt-link to="/units/Infantry_Units"
              >步兵</nuxt-link
            >與<nuxt-link to="/units/Villager">村民</nuxt-link
            >，但對抗<nuxt-link to="/units/Knight">騎士</nuxt-link>、<nuxt-link
              to="/units/Skirmisher"
              >矛兵</nuxt-link
            >與<nuxt-link to="/units/Siege_Weapons">攻城器</nuxt-link>較弱。
          </p>
          <p>
            除了<nuxt-link to="/civs/Spanish">西班牙</nuxt-link>和<nuxt-link
              to="/civs/Bulgarians"
              >保加利亞</nuxt-link
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>(+18%)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
              <nuxt-link to="/civs/Tatars">韃靼</nuxt-link>：弩兵高地戰鬥傷害+50%。<nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>免費。
            </li>
              <li>
              ...
              <li>
                <nuxt-link to="/civs/Vietnamese">越南</nuxt-link
                >：弩兵血量增加20%。<nuxt-link to="/techs/Conscription"
                  >徵兵技術</nuxt-link
                >免費。
              </li>
            </ul>
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>
                引入<nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>。
              </li>
          ...
          <div class="n1">
            <p>
              “弩是一種導彈武器，由連接到木材末端的一側的弓形物組成。弩像現代步槍一樣抵在肩膀上，然後用板機擊發彈藥。弩是在<nuxt-link
                to="/civs/Chinese"
                >中國</nuxt-link
              >古代發明的，但直到中世紀才在歐洲廣泛使用。它發射短的鑿子，石頭或金屬球而不是箭矢。這是一個強大的武器，但比最好的弓範圍更短。不過它使用簡單，製作相對便宜，而且依舊致命。一個只有練習弩幾個小時的農民也能很容易就殺死一個身著盔甲的並受過戰爭訓練的精銳騎士。歐洲的騎士一度試圖讓教會禁止武器。英國國王獅心王理查德就是在圍攻期間被弩槍所傷最後死亡。“
            </p>
          </div>
          <h3>圖庫</h3>
          <div class="hrn1"></div>
          <div class="row">
            ...
            <div class="col-md-4">
              <gallery
                ><img class="imgn hg" src="~assets/Crossbowmans.png" alt=""
              /></gallery>
              <p><em>一群弩兵</em></p>
            </div>
          </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +3對<nuxt-link to="/armor/Armor_Class_Spearman">槍兵類</nuxt-link>
            </td>
          </tr>
          <tr>
