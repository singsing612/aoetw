  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            ...
            >，但事實上，這並不涉及資源上的交換，一輛空的空的貿易車隊會從自己的<nuxt-link
              to="/building/Market"
              >市集</nuxt-link
            >出發到其他文明的市集並帶回黃金。而黃金的量取決於兩個市場的距離，越遠黃金就越多，反之。
          </p>
          <p>
            有趣的是貿易車隊不只只能和同盟國貿易甚至是中立、敵方的文明；當然除非敵方已經棄權，否則和敵對貿易是相當不明智的。
          </p>
          <p>
            貿易車隊每移動五格的距離就會生產出1單位的黃金，如果以最遠距離計算的話，一次可以得大的最大金額為517單位。
          </p>
          <p>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td class="tta1" style="width:10%">黃金收集速率</td>
            <td class="tta4">
              <img
                class="gg"
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                alt=""
              /><nuxt-link to="/techs/Caravan">商隊</nuxt-link>(+50%)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：有利於貿易車隊的<nuxt-link to="/techs">科技</nuxt-link
      ...
      <div class="col-md-4">
        ...
        <div class="thanks">感謝! 此頁面由小蝦協助編輯</div>
      </div>
    </div>
  </div>
</template>
