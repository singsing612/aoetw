        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img src="~assets/unique_tech.png" class="gg" alt="" /><nuxt-link
                to="/techs/Sipahi"
                >采邑騎兵</nuxt-link
              >(+20，<nuxt-link to="/civs/Turks">土耳其</nuxt-link>限定 )
            </td>
          </tr>
          <tr>
            ...
            <td class="tta4">
              ...
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Recurve_Bow">反曲弓</nuxt-link>(+1，
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              >(+1，<nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>限定)
            </td>
          </tr>
          <tr>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            ...
            >
              <div class="unititle" style="color: #fff">欽察</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
