      ...
      <div class="col-md-8">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <nuxt-link to="/civs/Cumans">庫曼</nuxt-link>、<nuxt-link to="/civs/Goths">哥德</nuxt-link>、<nuxt-link
                to="/civs/Huns"
                >匈人</nuxt-link
              >。
            </div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              HP，<nuxt-link to="/civs/Chinese">中國</nuxt-link>限定
            </td>
          </tr>
          <tr>
            <td class="tta1">
            ...
            <td class="tta4">
              ...
              >:箭塔可發射額外兩支箭，<nuxt-link to="/civs/Japanese"
                >日本</nuxt-link
              >限定
            </td>
          </tr>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Japanese">日本</nuxt-link>:引入<nuxt-link
                to="/techs/Yasama"
                >射箭孔</nuxt-link
              >，可讓箭塔可發射額外三支箭。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/guard_tower.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
